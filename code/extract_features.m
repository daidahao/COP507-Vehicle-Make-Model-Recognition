...
% Arguements:
%       dataset     -   Dataset to be extracted features from.
%       profile     -   Training profile generated by `generate_profiles()`.
% Returns:
%       features    -   A matrix of features representation, where each row
%                       is a feature vector.
